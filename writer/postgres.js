...
const copyData = require('./postgres/copy.js');
const transaction = require('./postgres/transaction.js');
...
ALTER TABLE "legacy_imported" CLUSTER ON "legacy_imported_pkey"`);
			...
			return transaction('Sessions', pool, async function(db) {
	...
	"expire" TIMESTAMP(6) NOT NULL
				...
				await require('./postgres/session.js')(db, reader, input);
